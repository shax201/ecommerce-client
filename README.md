[![shopper Screenshot](shopper image link from github)](vercel link )

# shopper

shopper is an open-source project that converts a Figma design of an e-commerce website into a fully responsive front-end application. It utilizes **Next.js 14 App Router**, **TypeScript**, **Tailwind CSS**, **Redux**, **Framer Motion**, and **ShadCN UI** to deliver a modern, scalable, and optimized solution based on industry standards.
...
shopper bridges the gap between design and development by converting Figma designs into production-ready code. The project follows best practices for **SEO**, **performance optimization**, and **accessibility**, making it a perfect foundation for developers looking to create scalable and maintainable e-commerce front-ends.

## Demo

Check out the live demo: [shopper Demo](vercel link)

<!-- [![shopper Screenshot](ss link)](vercel link) -->
...
To get started with shopper locally, follow these steps:

1. **Clone the repository:**

   ```bash
   git clone git url
   cd next-ecommerce-shopper
   ```
...
You can run the app in Docker for both development and production.
...
This mounts the project folder and runs `npm run dev` inside the container.

## Contributing

Contributions are welcome! If you'd like to contribute, Please follow these steps to contribute to shopper:
...
Feel free to submit issues for any bugs, feature requests, or general questions related to the project. You can also reach out via [email](mailto:rifat.rahman378@gmail.com) for support.
...
- **Name**: Rifat Rahman
- **Email**: [rifat.rahman378@gmail.com](mailto:rifat.rahman378@gmail.com)
- **GitHub**: [https://github.com/xer-on](https://github.com/xer-on)
